...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [
            ...
            InlineKeyboardButton('YT page', url='https://youtube.com/@Au0ffcial')
            ],
            [
    ...
    if len(message.command) != 2:
        buttons = [[
            ...
            InlineKeyboardButton('Watch Tutorial', url='https://youtube.com/@Auoffcial')
            ]]
        reply_markup = InlineKeyboardMarkup(buttons)
    ...
    if AUTH_CHANNEL and not await is_subscribed(client, message):
        try:
            ...
            logger.error("Da , main channelil add cheytho enni check chaii")
            return
        btn = [
            [
             ...
             [
                InlineKeyboardButton(
                    "🦋 SUBSCRIBE YT Channel 🦋", url='https://youtube.com/@Auoffcial'
                )
            ]
        ]
    ...
    if not files_:
        ...
        try:
            ...
            pass
        return await message.reply('E file admin delete chaithirikkunu / copyright adichu.')
    files = files_[0]
    ...
    if chat_type == enums.ChatType.PRIVATE:
        ...
        if grpid is not None:
            ...
            try:
                ...
                await message.reply_text("Njn ninthe gruopil undo enne check chaiyuu!!", quote=True)
                return
        else:
            await message.reply_text("Njn groupil ellada mwonuse!", quote=True)
            return
